...
export const ClaimConditionsForm: React.FC<ClaimConditionsFormProps> = ({
  ...
  function hasMultiphaseClaimConditions(): boolean {
  ...
  function hasLegacyClaimConditions(): boolean {
    return detectFeatures(contract, [
      // erc721
  ...
  const isMultiPhase = hasMultiphaseClaimConditions();
  const isClaimPhaseV1 = hasLegacyClaimConditions();
